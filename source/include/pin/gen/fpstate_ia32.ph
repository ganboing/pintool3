...
struct FPSTATE
{
    ...
    //   2. The upper 256 bits of zmm0-zmm7 (and padding for zmm8-zmm15)
    //   3. reserved - no zmm16-zmm31 on IA32
    struct VSTATE
    {
        UINT64 _kmasks[8];      // 8 64-bit k (opmask) registers                64   bytes at offset 1088
        UINT8  _zmmUpper[32*8]; // upper 256 bits of zmm0-zmm7                  256  bytes at offset 1152
        UINT8  _pad256[32*8];   // reserved - no zmm8-zmm15 on IA-32            256  bytes at offset 1408
        UINT8  _pad1024[64*16]; //                                              1024 bytes at offset 1664
    } _vstate;
